(function($) {
    ...
    $("#vendor-2-select").select2();
    $("#bank-select").select2();
    $("#currency-select").select2();
    $("#admin-select").select2();
    $("#tipe-vendor-select").select2();
    $("#ekspedisi-select").select2();
    $("#ajax-data-select").select2();
    $("#tipe-customer-select").select2();
    $("#country-select").select2();
    $("#city-select").select2();
    $("#city-preview").select2();
    $("#state-select").select2();
    $("#distric-select").select2();
    $("#tipe-customer-preview").select2();
    $("#channel-penjualan-select").select2();
    $("#kelompok-produk-select").select2();
