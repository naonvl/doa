                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 mb-6">
                                            <div class="example">
                                                ...
                                                &nbsp;
                                                <input type="button" name="submit" id="submit" class="btn btn-success me-6" style="margin: auto;width: 100px;color: white;" value="List Data QC" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('do_good_receipt_qc_view') ?>'" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                   <a href="<?php echo $__folder ?><?php echo obraxabrix('do_good_receipt_qc') ?>/<?php echo $row_good_receipt->ref ?>" class="btn btn-primary shadow btn-xs sharp me-1" target="_blank" ><i class="fas fa-pencil-alt"></i></a>
                                                </td>
                                            </tr>
