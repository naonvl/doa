...
?>		
		<!--<tr style="background-color:ffffff;" id="item_ajax2_<?php echo $no; ?>" > -->
			...
			<td align="left">
				<input type="text" id="item_code2" name="item_code2" style="font-size: 12px; min-width: 150px" class="form-control" onKeyPress="return focusNext('submit_det',event)" onchange="loadHTMLPost3('app/pos_detail_ajax.php','item_ajax','getdata','item_code2','location_id2')" value="<?php echo $kode ?>" >
			</td>
			
			<td align="left">
				<input type="text" id="item_name" name="item_name" readonly="" style="font-size: 12px; min-width: 300px" class="form-control" value="<?php echo $item_name ?>" >
			</td>
			...
			<td align="center">
				<input type="text" id="qty" name="qty" style="text-align: right; font-size: 12px; width: 100px" class="form-control" onKeyPress="return focusNext('submit_det',event)" onkeyup="formatangka('qty'), detailvalue2()" value="1" >
			</td>
			<td align="center">
			...
			<td align="center" id="amount_det">
				<input type="text" id="amount" name="amount" readonly="" style="text-align: right; font-size: 12px; width: 120px" class="form-control" onkeyup="formatangka('amount')" value="<?php echo $amount ?>" >
			</td>
...
?>		
			...
			<td>
				<select id="uom_code" name="uom_code" style="height: 35px; width: auto; font-size: 12px">
					<?php 
						select_uom($uom_code) 
					?>
				</select>	
...
?>		
			...
			<td align="left">
				<select class="destroy-selector" id="item_code_<?= $no ?>" name="item_code_<?= $no ?>" onchange="loadHTMLPost3('app/pos_detail_ajax.php','item_ajax_<?= $no ?>','getdata2','item_code_<?= $no ?>','location_id')" >
                    <option value=""></option>
