...
function FPDF2($orientation='P', $unit='mm', $format='A4', $size='0')
{
	...
	$this->PageFormats=array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89), 'a5'=>array(420.94,595.28),
		'letter'=>array(612,792), 'legal'=>array(612,1008), 'auto'=>array(595, $size), 'tmsize'=>array(350, $size), 'qrcode'=>array(350, 425) ); //350
	if(is_string($format))
...
function _dochecks()
{
	...
	// deactivate magic_quotes_runtime
...
function _putimages()
{
	...
	foreach($this->images as $file => $info) //revision 2021-08-22 
	{
		$this->_newobj();
