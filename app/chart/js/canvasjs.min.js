...
(function() {
    ...
    function fb(h) {
        if (T.fSDec) h[ja("`eeDwdouMhrudods")](ja("e`u`@ohl`uhnoHuds`uhnoDoe"), function() {
            T._fTWm && T._fTWm(h)
        })
    }
    ...
    function I(h, n, E, w, U) {
        ...
        w.push([h, n, E, U]);
        return h.addEventListener ? (h.addEventListener(n, E, U), E) : h.attachEvent ? (w = function(n) {
            n = n || window.event;
    ...
    function hb(h) {
        if (h._menuButton) h.exportEnabled ?
            ...
            I(h._menuButton, "touchstart", function(h) {
                n = !0
            }, h.allDOMEventHandlers);
            I(h._menuButton, "click", function() {
            ...
            I(h._menuButton, "mousemove", function() {
                n || (V(h._menuButton, {
            ...
            I(h._menuButton, "mouseout", function() {
                n || (V(h._menuButton, {
                    backgroundColor: h.toolbar.itemBackgroundColor,
                    color: h.toolbar.fontColor
                }), 0 >= navigator.userAgent.search("MSIE") && V(h._menuButton.childNodes[0], {
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            for (var E = h._dropdownMenu.childNodes, r = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], U = 0; U < E.length; U++) V(E[U], {
                    backgroundColor: h.toolbar.itemBackgroundColor,
                    color: h.toolbar.fontColor
                }),
                E[U].innerHTML = r[U]
            ...
            }), E.innerHTML = h._cultureInfo.printText, E.style.backgroundColor = h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E),
            I(E, "touchstart", function(h) {
                n = !0
            }, h.allDOMEventHandlers), I(E, "mousemove", function() {
                n || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover)
            }, h.allDOMEventHandlers, !0), I(E, "mouseout", function() {
                n || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor)
            }, h.allDOMEventHandlers, !0), I(E, "click", function() {
                h.print();
                wa(h._dropdownMenu)
            }, h.allDOMEventHandlers, !0), E = document.createElement("div"), V(E, {
                padding: "12px 8px 12px 8px"
            }),
            E.innerHTML = h._cultureInfo.saveJPGText, E.style.backgroundColor = h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E), I(E, "touchstart", function(h) {
                n = !0
            }, h.allDOMEventHandlers), I(E, "mousemove", function() {
                n || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover)
            }, h.allDOMEventHandlers, !0), I(E, "mouseout", function() {
                ...
                padding: "12px 8px 12px 8px"
            }), E.innerHTML = h._cultureInfo.savePNGText, E.style.backgroundColor = h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E), I(E, "touchstart", function(h) {
                n = !0
            }, h.allDOMEventHandlers), I(E, "mousemove", function() {
    ...
    function Ma(h, n, E) {
        if (w && $a) {
            ...
            h.width = n * la;
            h.height = E * la;
            Ra !== Na && (h.style.width = n + "px", h.style.height = E + "px", r.scale(la, la))
    ...
    function ib(h) {
        if (!jb) {
            ...
            "undefined" === typeof ra.Chart.creditHref ? (h.creditHref = ja("iuuqr;..b`ow`rkr/bnl."),
                h.creditText = ja("B`ow`rKR/bnl")) : (n = h.updateOption("creditText"), r = h.updateOption("creditHref"));
            if (h.creditHref && h.creditText) {
                ...
                if (0 === h.renderCount || n || r) h._creditLink.setAttribute("href", h.creditHref), h._creditLink.innerHTML = h.creditText;
    ...
    function xa(h, n, r) {
        ...
        n.getAttribute("state") !==
            r && (n.setAttribute("state", r), n.setAttribute("type", "button"), V(n, {
                padding: "5px 12px",
                cursor: "pointer",
                "float": "left",
                width: "40px",
                ...
                lineHeight: "0"
            }), n.setAttribute("title", h._cultureInfo[r + "Text"]), n.innerHTML = "<img src='" + kb[r].image + "' alt='" + h._cultureInfo[r + "Text"] + "' />", V(n.childNodes[0], {
                height: "95%",
                pointerEvents: "none"
            }))
    }
    ...
    function Sa(h, n, r, w, U) {
        if (null === h || "undefined" === typeof h) return "undefined" === typeof r ? n : r;
        h = parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? n / 100 : 1);
        "undefined" !== typeof w && (h = Math.min(w, h), "undefined" !== typeof U && (h = Math.max(U, h)));
    ...
    function za(h, n) {
        ...
        if (r(this.options.margin) && h.options.subtitles)
            for (var E = h.options.subtitles, w = 0; w < E.length; w++)
                if ((r(E[w].horizontalAlign) && "center" === this.horizontalAlign || E[w].horizontalAlign === this.horizontalAlign) && (r(E[w].verticalAlign) && "top" === this.verticalAlign || E[w].verticalAlign === this.verticalAlign) && !E[w].dockInsidePlotArea === !this.dockInsidePlotArea) {
                    this.margin = 0;
                    break
                }
    ...
    (function() {
        T.fSDec = function(h) {
            for (var n = "", r = 0; r < h.length; r++) n += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(r));
            return n
        };
        delete ra[T.fSDec("Bi`su")][T.fSDec("bsdehuIsdg")];
        T.pro = {
            sCH: ra[T.fSDec("Bi`su")][T.fSDec("bsdehuIsdg")]
        };
        T.pos = ["cm",
            "cs", "um"
        ];
        T._fTWm = function(h) {
            if ("undefined" === typeof T.pro.sCH && !cb) try {
                var n = (new Date).getMonth() % 3,
                    r, w, U = h[T.fSDec("buy")];
                U[T.fSDec("udyuC`rdmhod")] = T.fSDec("unq");
                U[T.fSDec("gnou")] = 11 + T.fSDec("qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg");
                U[T.fSDec("ghmmRuxmd")] = T.fSDec("fsdx");
                r = "cm" === T.pos[n] || "um" === T.pos[n] ? 0 : h.width - U[T.fSDec("ld`rtsdUdyu")](T.fSDec("B`ow`rKR!Ush`m")).width;
                w = "um" === T.pos[n] ? 0 : h.height - 11;
                U[T.fSDec("ghmmUdyu")](T.fSDec("B`ow`rKR!Ush`m"), r, w);
                "cs" ===
                T.pos[n] && (h[T.fSDec("^bsdehuMhoj")].style.right = T.fSDec("`tun"))
            } catch (v) {}
        }
    })();
    var gb = function() {
                ...
                return P = J.replace(h, function(l) {
                    switch (l) {
                        ...
                        case "TT":
                            return 12 > d ? "AM" : "PM";
                        case "K":
                            return T ? "UTC" : (String(B).match(v) || [""]).pop().replace(A, "");
                        case "z":
                            return (0 < f ? "-" : "+") + Math.floor(Math.abs(f) / 60);
                        case "zz":
                            return (0 < f ? "-" : "+") + ba(Math.floor(Math.abs(f) / 60), 2);
                        case "zzz":
                            return (0 < f ? "-" : "+") + ba(Math.floor(Math.abs(f) / 60), 2) + ba(Math.abs(f) % 60, 2);
                        default:
        ...
        ha = function(h, n, r) {
            ...
            for (var N = 0; B && N < B.length; N++)
                if (n = B[N], "." === n && 0 > J) J = N;
                    ...
                    0 > J ? (P.push(n), "#" === n || "0" === n ? Q++ : "," === n && K++) : (O.push(n), "#" !== n && "0" !== n || I++)
                } T && (n = Math.floor(h), B = -Math.floor(Math.log(h) / Math.LN10 + 1), V = 0 === h ? 0 : 0 === n ? -(Q +
                B) : String(n).length - Q, A /= Math.pow(10, V));
            0 > J && (J = N);
            A = (h * A).toFixed(I);
            n = A.split(".");
            A = (n[0] + "").split("");
                ...
                if (n = P.pop(), "#" === n || "0" === n)
                    if (J++, J === Q) {
                        var aa = A,
                            A = [];
                        if ("0" === n)
                            for (n = Q - I - (aa ? aa.length : 0); 0 < n;) aa.unshift("0"), n--;
                        for (; 0 < aa.length;) r = aa.pop() + r, T++, 0 === T % B && (N === K && 0 < aa.length) && (r = v + r)
                    } else 0 < A.length ? (r = A.pop() + r, I++, T++) : "0" === n && (r = "0" + r, I++, T++), 0 === T % B && (N === K && 0 < A.length) && (r = v + r);
            else "E" !== n[0] && "e" !==
                n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? "," === n ? (N++, B = T, T = 0, 0 < A.length && (r = v + r)) : r = 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? n.slice(1, n.length - 1) + r : n + r : (n = 0 > V ? n.replace("+", "").replace("-", "") : n.replace("-", ""), r += n.replace(/[0]+/, function(a) {
                    return ba(V, a.length)
                }));
            v = "";
            for (P = !1; 0 < O.length;) n = O.shift(), "#" === n || "0" === n ? 0 < h.length && 0 !== Number(h.join("")) ? (v += h.shift(), P = !0) : "0" === n && (v += "0", P = !0) : 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" ===
                n[0] && "'" === n[n.length - 1]) ? v += n.slice(1, n.length - 1) : "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? v += n : (n = 0 > V ? n.replace("+", "").replace("-", "") : n.replace("-", ""), v += n.replace(/[0]+/, function(a) {
                return ba(V, a.length)
            }));
            r += (P ? U : "") + v;
            return w ? "-" + r : r
        ...
        da = function(h, n, r, w, v, B, A, J, Q, P, T, O, I) {
            ...
            h.globalAlpha = 1;
            0 < A && (I = 0 === A % 2 ? 0 : 0.5, h.beginPath(), h.lineWidth = A, h.strokeStyle = J, h.moveTo(n, r), h.rect(n - I, r - I, w - n + 2 * I, v - r + 2 * I), h.stroke());
            h.restore();
            !0 === Q && (h.save(), h.beginPath(), h.moveTo(n, r), h.lineTo(n + K, r + K), h.lineTo(w -
                K, r + K), h.lineTo(w, r), h.closePath(), A = h.createLinearGradient((w + n) / 2, r + K, (w + n) / 2, r), A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = A, h.fill(), h.restore());
            !0 === P && (h.save(), h.beginPath(), h.moveTo(n, v), h.lineTo(n + K, v - K), h.lineTo(w - K, v - K), h.lineTo(w, v), h.closePath(), A = h.createLinearGradient((w + n) / 2, v - K, (w + n) / 2, v), A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = A, h.fill(), h.restore());
            !0 === T && (h.save(), h.beginPath(), h.moveTo(n, r), h.lineTo(n + K, r +
                K), h.lineTo(n + K, v - K), h.lineTo(n, v), h.closePath(), A = h.createLinearGradient(n + K, (v + r) / 2, n, (v + r) / 2), A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, h.fill(), h.restore());
            !0 === O && (h.save(), h.beginPath(), h.moveTo(w, r), h.lineTo(w - K, r + K), h.lineTo(w - K, v - K), h.lineTo(w, v), A = h.createLinearGradient(w - K, (v + r) / 2, w, (v + r) / 2), A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, h.fill(),
    ...
    za.prototype.setLayout = function() {
        if (this.text) {
            ...
            P = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (v = n.y1 + 2, I = "top") : "bottom" === this.verticalAlign && (v = n.y2 - 2 - P.height, I = "bottom"), "left" === this.horizontalAlign ? w = n.x1 + 2 : "center" === this.horizontalAlign ? w = n.x1 + n.width / 2 - P.width / 2 : "right" === this.horizontalAlign && (w = n.x2 - 2 - P.width - A), K = this.horizontalAlign,
    ...
    Ua.prototype.get = function(h, r) {
        var w =
            null;
        0 < this.pool.length ? (w = this.pool.pop(), Ma(w, h, r)) : w = va(h, r);
        return w
    };
    ...
    v = Pa.Chart = function() {
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ?
                ...
                (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ca(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Ca(this._preRenderCtx), w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = va(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
                    this.overlaidCanvas = va(a, d), this.overlaidCanvas.style.position = "absolute", this.overlaidCanvas.style.webkitTapHighlightColor = "transparent", this.overlaidCanvas.style.WebkitUserSelect = "none", this.overlaidCanvas.style.MozUserSelect = "none", this.overlaidCanvas.style.msUserSelect = "none", this.overlaidCanvas.style.userSelect = "none", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline =
                        "top", Ca(this.overlaidCanvasCtx)), this._eventManager = new X(this), this.windowResizeHandler = I(window, "resize", function() {
                        ...
                        x2: this.width,
                        y2: this.height
                    }, I(this.overlaidCanvas, "click", function(a) {
                            b._mouseEventHandler(a)
                        },
                        this.allDOMEventHandlers), I(this.overlaidCanvas, "mousemove", function(a) {
                        b._mouseEventHandler(a)
                    }, this.allDOMEventHandlers), I(this.overlaidCanvas, "mouseup", function(a) {
                        b._mouseEventHandler(a)
                    }, this.allDOMEventHandlers), I(this.overlaidCanvas, "mousedown", function(a) {
                        b._mouseEventHandler(a);
                        wa(b._dropdownMenu)
                    }, this.allDOMEventHandlers), I(this.overlaidCanvas, "mouseout", function(a) {
                        b._mouseEventHandler(a)
                    }, this.allDOMEventHandlers), I(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" :
                        "touchstart",
                        function(a) {
                            b._touchEventHandler(a)
                        }, this.allDOMEventHandlers), I(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerMove" : "touchmove", function(a) {
                        b._touchEventHandler(a)
                    }, this.allDOMEventHandlers), I(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerUp" : "touchend", function(a) {
                        b._touchEventHandler(a)
                    }, this.allDOMEventHandlers), I(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerCancel" : "touchcancel", function(a) {
                        b._touchEventHandler(a)
                    }, this.allDOMEventHandlers),
        ...
        function B(a, d, c, b, e, f, l, s, D, k) {
            ...
            a.beginPath();
            D && 0 < s.thickness ? (a.moveTo(b - l.thickness / 2, Math.round((c + e) / 2) - p), a.lineTo(d + l.thickness / 2, Math.round((c + e) / 2) - p)) : 0 < s.thickness && (a.moveTo(Math.round((d +
        ...
        function W(a, d, c, b) {
            W.base.constructor.call(this, "DataSeries", "data", d, c,
                a);
            this.chart = a;
            this.canvas = a.canvas;
        ...
        n.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton) V(this._zoomButton, {
                    ...
                    I(this._zoomButton, "touchstart", function(a) {
                        d = !0
                    }, this.allDOMEventHandlers);
                    ...
                    I(this._zoomButton, "mousemove", function() {
                ...
                this._resetButton ? (V(this._resetButton, {
                    ...
                    this.toolbar.buttonBorderColor, this._toolBar.appendChild(this._resetButton), I(this._resetButton, "touchstart", function(a) {
                        d = !0
                    ...
                    I(this._resetButton, "mousemove", function() {
                        d || (V(a._resetButton, {
                            backgroundColor: a.toolbar.itemBackgroundColorOnHover,
                            color: a.toolbar.fontColorOnHover,
                            transition: "0.4s",
                    ...
                    }, this.allDOMEventHandlers), I(this._resetButton, "mouseout", function() {
                        d || (V(a._resetButton, {
                                backgroundColor: a.toolbar.itemBackgroundColor,
                                color: a.toolbar.fontColor,
                                transition: "0.4s",
        ...
        n.prototype.renderElements = function() {
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                    ...
                    "line" === s.type ? D = this.renderLine(s) : "stepLine" === s.type ? D = this.renderStepLine(s) : "spline" === s.type ? D = this.renderSpline(s) : "column" === s.type ? D = this.renderColumn(s) : "bar" === s.type ? D = this.renderBar(s) : "area" === s.type ? D = this.renderArea(s) : "stepArea" === s.type ? D = this.renderStepArea(s) :
                        ...
                        s.type && (D = this.renderBoxAndWhisker(s));
        ...
        n.prototype._processStackedPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d =
                        a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], s = [], D = Infinity, k = -Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    for (q = 0; q < p.dataPoints.length; q++) {
                        ...
                        if (b < fa &&
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === p.dataPoints[q].y ? c.viewPortMin === b && h < b && (c.viewPortMin = h) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l[b] ? l[b] += e : (l[b] = e, D = Math.min(e, D)) : s[b] ? s[b] += e : (s[b] = e, k = Math.max(e,
                                k)))
                        }
                    }
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, s = !1, D = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    ...
                    if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var h = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                        fa = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
                        this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
                    ...
                    for (p = 0; p < m.dataPoints.length; p++) {
                        ...
                        if (b < h && !q) null !== e && (t = b);
                            ...
                            m.dataPoints[p].label && (a.axisX.labels[b] =
                ...
                a.axisY.logarithmic ? (d.max = r(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase,
        ...
        n.prototype._processMultiYPlotUnit = function(a) {
            if (a.dataSeriesIndexes &&
                ...
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, s = !1, D = 0; D < a.dataSeriesIndexes.length; D++) {
                    ...
                    for (m = 0; m < k.dataPoints.length; m++) {
                        ...
                        k.dataPoints[m].x.getTime ?
                            (s = !0, b = k.dataPoints[m].x.getTime()) : b = k.dataPoints[m].x;
                        ...
                        f < d.min && (d.min = f);
                        l > d.max && (d.max = l);
                        0 < m && (a.axisX.logarithmic ? (t = b / k.dataPoints[m - 1].x, 1 > t && (t = 1 / t), c.minDiff > t && 1 !== t && (c.minDiff = t)) : (t = b - k.dataPoints[m - 1].x, 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t)), e && (null !== e[0] && k.dataPoints[m - 1].y && null !==
                            k.dataPoints[m - 1].y[0]) && (a.axisY.logarithmic ? (t = e[0] / k.dataPoints[m - 1].y[0], 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e[0] - k.dataPoints[m - 1].y[0], 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t))));
                        if (!(b < r) || p) {
                            if (!p && (p = !0, 0 < m)) {
                                m -= 2;
                                g = h;
        ...
        n.prototype._processSpecificPlotUnit = function(a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (s.dataPoints[D].x && s.dataPoints[D].x.getTime || "dateTime" === s.xValueType) f = !0;
                    for (D = 0; D < s.dataPoints.length; D++) "undefined" !== typeof s.dataPoints[D].isCumulativeSum && !0 === s.dataPoints[D].isCumulativeSum ? (s.dataPointEOs[D].cumulativeSumYStartValue = 0, s.dataPointEOs[D].cumulativeSum = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum, s.dataPoints[D].y = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum) : "undefined" !== typeof s.dataPoints[D].isIntermediateSum &&
                        !0 === s.dataPoints[D].isIntermediateSum ? (s.dataPointEOs[D].cumulativeSumYStartValue = p, s.dataPointEOs[D].cumulativeSum = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum, s.dataPoints[D].y = 0 === D ? 0 : b, p = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum, b = 0) : (e = "number" !== typeof s.dataPoints[D].y ? 0 : s.dataPoints[D].y, s.dataPointEOs[D].cumulativeSumYStartValue = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum, s.dataPointEOs[D].cumulativeSum = 0 === D ? e : s.dataPointEOs[D - 1].cumulativeSum + e, b += e);
                    for (D = 0; D < s.dataPoints.length; D++)
                        if ("undefined" ===
        ...
        n.prototype.calculateAutoBreaks = function() {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c)
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, l = f.min, k = f.max, m = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, s = 0, D = 0; D < a.dataSeriesIndexes.length; D++) {
                            ...
                            if (!(4 > h.dataPoints.length))
                                for (s = 0; s < h.dataPoints.length; s++)
                                    if (b && (q = (k + 1 - l) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[s].x.getTime ? h.dataPoints[s].x.getTime() : h.dataPoints[s].x, q = Math.floor((g - l) / q), g < f[q].min &&
                                        ...
                                        else r(g) || (q = Math.floor((g - m) / n), g < d[q].min && (d[q].min = g), g > d[q].max && (d[q].max = g))
                                    }
                        }
                }
            }
                ...
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks &&
                    ...
                    for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, l = 0, k = 0; k < a.dataSeriesIndexes.length; k++) {
                        ...
                        if (!(4 > m.dataPoints.length))
                            for (l = 0; l < m.dataPoints.length; l++) g = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = m.dataPoints[l].x.getTime ? m.dataPoints[l].x.getTime() : m.dataPoints[l].x, g = Math.floor((b - c) / g), b < f[g].min && (f[g].min = b), b > f[g].max && (f[g].max =
                                b)
                    }
            }
                ...
                for (l = 0; l < this._axes.length; l++)
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                            ...
                            m = k;
                            for (s in q) q.hasOwnProperty(s) && !isNaN(s) && (p = -1 * q[s], r(p) || (g = Math.floor((p - D) / b), p < m[g].min && (m[g].min = p), p > m[g].max && (m[g].max = p)));
        ...
        n.prototype.validateRegion = function(a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), s = !1, D = [], k = [], m = [], p = 0; p < this._axes.length; p++)("axisX" === this._axes[p].type &&
            ...
            for (l = 0; l < k.length; l++) {
                ...
                if (isFinite(p.dataInfo.minDiff))
                    if (t = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
                            (p.logarithmic && t < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && t < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) D.push(p), m.push({
                        val1: q,
                        val2: g
                    }), s = !0;
                    else if (!e) {
        ...
        n.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var fa = ma("indexLabelLineDashType", m.dataPoint, m.dataSeries),
                    ...
                    n = r(m.dataPoint.indexLabelLineThickness) ? r(m.dataSeries.options.indexLabelLineThickness) ? 0 : m.dataSeries.options.indexLabelLineThickness : m.dataPoint.indexLabelLineThickness,
                ...
                if (null !== G && "" !== G) {
                    ...
                    if ("normal" ===
                        ...
                        "inside" !== x ? (e = c.y1, f = c.y2, 0 < v ? (g = m.point.y + ("horizontal" === z ? t / 2 : 0) - k - s - b, g < e && (g = "auto" === x ? Math.max(m.point.y, e) + t / 2 + s : e + t / 2 + s, A = g + k > m.point.y)) : (g = m.point.y + t / 2 + s + b, g > f - k && (g = "auto" === x ? Math.min(m.point.y, f) + t / 2 - k - s : f + t / 2 - k, A = g < m.point.y))) : (e = Math.max(m.bounds.y1,
                            c.y1), f = Math.min(m.bounds.y2, c.y2 - k + t / 2), b = 0 <= p.indexOf("range") || "error" === p ? 0 < v ? Math.max(m.bounds.y1, c.y1) + t / 2 + s : Math.min(m.bounds.y2, c.y2) + t / 2 - k + s : (Math.max(m.bounds.y1, c.y1) + Math.min(m.bounds.y2, c.y2)) / 2 - k / 2 + t / 2 + ("horizontal" === z ? s : 0), 0 < v ? (g = Math.max(m.point.y, b), g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(m.point.y - k - s, c.y1 + s))) : (g = Math.min(m.point.y, b), g > f - k - s && ("bubble" === p || "scatter" === p) && (g = Math.min(m.point.y + s, c.y2 - k - s))), g = Math.min(g, f))
                        ...
                        0 <= p.indexOf("scatter") ? (x = "auto", l = 4) : 0 <= p.indexOf("stacked") ? "auto" === x && (x = "inside") : "bubble" === p && (x = "inside"), g = m.point.y + t / 2 - k / 2 + s, "inside" !== x ? (e = c.x1, f = c.x2, 0 > v ? (q = m.point.x - ("horizontal" === z ? D : D - t / 2) - l - b, q < e && (q = "auto" === x ? Math.max(m.point.x, e) + l : e + l, A = q + D > m.point.x)) : (q = m.point.x + ("horizontal" === z ? 0 : t / 2) + l + b, q > f - D - l - b && (q = "auto" === x ? Math.min(m.point.x, f) - ("horizontal" === z ? D : D / 2) - l : f - D - l, A = q < m.point.x))) : (e = Math.max(m.bounds.x1, c.x1), Math.min(m.bounds.x2, c.x2), b = 0 <= p.indexOf("range") || "error" ===
                            p ? 0 > v ? Math.max(m.bounds.x1, c.x1) + t / 2 + l : Math.min(m.bounds.x2, c.x2) - D / 2 - l + ("horizontal" === z ? 0 : t / 2) : (Math.max(m.bounds.x1, c.x1) + Math.min(m.bounds.x2, c.x2)) / 2 + ("horizontal" === z ? 0 : t / 2), q = 0 > v ? Math.max(m.point.x, b) - ("horizontal" === z ? D / 2 : 0) : Math.min(m.point.x, b) - D / 2, q = Math.max(q, e));
                    "vertical" === z && (g += k - t / 2);
                    h.x = q;
                    h.y = g;
                    h.render(!0);
                    n && ("inside" !== x && (0 > p.indexOf("bar") && ("error" !== p || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2 || !A) && (0 > p.indexOf("column") && ("error" !== p || m.axisSwapped) && m.point.y > c.y1 &&
                        ...
                        z ? g - k < m.point.y ? 0 : -k : (g - t / 2 < m.point.y ? k : 0) - t / 2)), d.stroke())
                }
            }
            d = {
                source: d,
            ...
            for (a = 0; a < this._indexLabels.length; a++) m = this._indexLabels[a], h = ma("indexLabelBackgroundColor", m.dataPoint, m.dataSeries), m.dataSeries.indexLabelBackgroundColor = r(h) ? w ? "transparent" : null : h;
            return d
        };
                    ...
                    if (0 < m.length) {
                        for (var z = !1, u = 0; u < m.length; u++)
                            if (n = m[u].x.getTime ? m[u].x.getTime() : m[u].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || z || r) && (c.stroke(), w && b.stroke()), z = !0;
                                else {
                                    ...
                                    r || z ? (!r && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(n, x), w && b.lineTo(n, x)) : (c.beginPath(), c.moveTo(n, x), w && (b.beginPath(),
                                        b.moveTo(n, x))), z = r = !1) : (c.lineTo(n, x), w && b.lineTo(n, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(n, x), w && (b.stroke(), b.beginPath(), b.moveTo(n, x))));
                                    l = {
                                        x: n,
                                        y: x
                                    };
                                    u < m.length - 1 && (h !== (m[u].lineColor || t) || p !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(n, x), h = m[u].lineColor || t, c.strokeStyle = h, c.setLineDash && (m[u].lineDashType ? (p = m[u].lineDashType, c.setLineDash(J(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
                            ...
                            if (n = m[u].getTime ? m[u].x.getTime() : m[u].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
                                if ("number" !== typeof m[u].y) 0 <
                                    ...
                                    r || z ? (!r && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)),
                                        c.lineTo(n, G), c.lineTo(n, x), w && (b.lineTo(n, G), b.lineTo(n, x))) : (c.beginPath(), c.moveTo(n, x), w && (b.beginPath(), b.moveTo(n, x))), z = r = !1) : (c.lineTo(n, G), w && b.lineTo(n, G), c.lineTo(n, x), w && b.lineTo(n, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(n, x), w && (b.stroke(), b.beginPath(), b.moveTo(n, x))));
                                    l = {
                                        x: n,
                                        y: x
                                    };
                                    u < m.length - 1 && (h !== (m[u].lineColor || t) || p !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(n, x), h = m[u].lineColor || t, c.strokeStyle = h, c.setLineDash && (m[u].lineDashType ? (p = m[u].lineDashType,
                                        c.setLineDash(J(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
                                    if (0 < m[u].markerSize || 0 < k.markerSize) G = k.getMarkerProperties(u, n, x, c), f.push(G), C = Q(C), w && f.push({
                                        x: n,
                                        y: x,
                                        ctx: b,
                                        type: G.type,
                    ...
                    if (0 < m.length)
                        for (n = !1, r = 0; r < m.length; r++)
                            if (u = m[r].getTime ? m[r].x.getTime() : m[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !n)))
                                if ("number" !== typeof m[r].y) 0 < r && !n && (k.connectNullData ? b.setLineDash && (0 < x.length && (k.options.nullDataLineDashType || !m[r - 1].lineDashType)) && (x[x.length - 1].newLineDashArray = q, p = k.nullDataLineDashType) :
                                    (d(x), x = [])), n = !0;
                                else {
                                    ...
                                    r < m.length - 1 && (h !== (m[r].lineColor || t) || p !== (m[r].lineDashType || k.lineDashType)) && (h = m[r].lineColor || t, x[x.length - 1].newStrokeStyle = h, b.setLineDash && (m[r].lineDashType ? (p = m[r].lineDashType, x[x.length - 1].newLineDashArray = J(p, k.lineThickness)) : (p = k.lineDashType,
        ...
        n.prototype.renderColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    l, s, D, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < t.length)
                        for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < t.length; f++)
                            if (t[f].getTime ? D = t[f].x.getTime() :
                                ...
                                b = Q(b);
                                w && da(this._eventManager.ghostCtx, a.axisX.reversed ? r : l, s, a.axisX.reversed ? l : r, u, b, 0, null, !1, !1, !1, !1);
        ...
        n.prototype.renderStackedColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                t = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(t) /
                    Math.log(a.axisX.range) : Math.abs(t) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                m = m - a.plotType.plotUnits.length * t / 2 + a.index * t << 0;
                                var x = m + t << 0,
                                    z;
                                if (a.axisY.logarithmic ||
                                    a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) s[b] = u[k].y + (s[b] ? s[b] : 0), 0 < s[b] && (p = a.axisY.convertValueToPixel(s[b]), z = "undefined" !== typeof f[b] ? f[b] : q, f[b] = p);
                                    ...
                                    l[b] ? l[b] : 0, z = p + G, p = q + G, l[b] = G + (z - p);
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                                da(c, m, a.axisY.reversed ? z : p, x, a.axisY.reversed ? p : z, b, 0, null, n && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && n, !1, !1, r.fillOpacity);
                                b = r.dataPointIds[k];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = Q(b);
                                w && da(this._eventManager.ghostCtx, m, p, x, z, b, 0, null, !1, !1, !1, !1);
        ...
        n.prototype.renderStackedColumn100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                t = this.options.dataPointWidth ?
                    this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(t) / Math.log(a.axisX.range) : Math.abs(t) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
                this.dataPointMaxWidth && k > g && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, g));
                !this.dataPointMaxWidth && (this.dataPointMinWidth && g < k) && (g = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k));
                t < k && (t = k);
                t > g && (t = g);
                ...
                for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var h = a.dataSeriesIndexes[g],
                        ...
                        u = r.dataPoints;
                    if (0 < u.length)
                        for (var n = 5 < t && r.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                m = a.axisX.convertValueToPixel(b);
                                ...
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                                da(c, m, a.axisY.reversed ? z : p, x, a.axisY.reversed ? p : z, b, 0, null, n && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) &&
                                    n, !1, !1, r.fillOpacity);
                                b = r.dataPointIds[k];
                                this._eventManager.objectMap[b] = {
                                    id: b,
        ...
        n.prototype.renderBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                this.dataPointMaxWidth && f > m && (f =
                    Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m));
                    ...
                    if (0 < t.length) {
                        ...
                        for (f = 0; f < t.length; f++)
                            if (t[f].getTime ? D = t[f].x.getTime() : D = t[f].x, !(D < a.axisX.dataInfo.viewPortMin || D > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[f].y) {
                                ...
                                s = a.axisX.reversed ? s + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + m) * p << 0 : s - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount +
                                    m) * p << 0;
                                ...
                                b = Q(b);
                                w && da(this._eventManager.ghostCtx, u, a.axisX.reversed ? r : s, l, a.axisX.reversed ? s : r, b, 0, null, !1, !1, !1, !1);
                                (t[f].indexLabel ||
        ...
        n.prototype.renderStackedBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                isFinite(t) || (t = 0.3 * Math.abs(a.axisX.range));
                t = this.options.dataPointWidth ?
                    this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(t) / Math.log(a.axisX.range) : Math.abs(t) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
                this.dataPointMaxWidth && k > g && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, g));
                !this.dataPointMaxWidth && (this.dataPointMinWidth && g < k) && (g = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k));
                t < k && (t = k);
                t > g && (t = g);
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                var x = p + t << 0,
                                    z;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) s[b] = u[k].y + (s[b] ? s[b] : 0), 0 < s[b] && (z = f[b] ? f[b] : q, f[b] = m = a.axisY.convertValueToPixel(s[b]));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) D[b] = u[k].y + (D[b] ? D[b] : 0), m = l[b] ? l[b] : q, l[b] = z = a.axisY.convertValueToPixel(D[b]);
                                ...
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                                da(c, a.axisY.reversed ? m : z, p, a.axisY.reversed ? z : m, x, b, 0, null, n, !1, !1, !1, r.fillOpacity);
                                b = r.dataPointIds[k];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = Q(b);
                                w && da(this._eventManager.ghostCtx, z, p, m, x, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
        ...
        n.prototype.renderStackedBar100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    ...
                    t = a.axisX.dataInfo.minDiff;
                isFinite(t) || (t = 0.3 * Math.abs(a.axisX.range));
                t = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(t) /
                    Math.log(a.axisX.range) : Math.abs(t) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
                this.dataPointMaxWidth && k > g && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, g));
                !this.dataPointMaxWidth && (this.dataPointMinWidth && g < k) && (g = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k));
                t < k && (t = k);
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) D[b] = x + (D[b] ? D[b] : 0), m = l[b] ? l[b] : q, l[b] = x = a.axisY.convertValueToPixel(D[b]);
                                else if (m = a.axisY.convertValueToPixel(x), 0 <= u[k].y) {
                                    var G = f[b] ? f[b] : 0;
                                    x = q + G;
                                    m += G;
                                    a.dataSeriesIndexes.length - 1 === g &&
                                        1 >= Math.abs(e.x2 - m) && (m = e.x2);
                                    f[b] = G + (m - x)
                                } else G = l[b] ? l[b] : 0, x = m - G, m = q - G, a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.x1 - x) && (x = e.x1), l[b] = G + (m - x);
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                                da(c, a.axisY.reversed ? m : x, p, a.axisY.reversed ? x : m, z, b, 0, null, n, !1, !1, !1, r.fillOpacity);
                                b = r.dataPointIds[k];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = Q(b);
                                w && da(this._eventManager.ghostCtx, x, p, m, z, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
        ...
        n.prototype.renderArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    d = !0;
                    var h = 0,
                        r, u, n, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                    ...
                    if (0 < t.length) {
                        ...
                        for (var ca = !0; h < t.length; h++)
                            if (n = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ca)))
                                if ("number" !==
                                    typeof t[h].y) g.connectNullData || (ca || d) || b(), ca = !0;
                                else {
                                    r = a.axisX.convertValueToPixel(n);
                                    u = a.axisY.convertValueToPixel(t[h].y);
                                    d || ca ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = r, c = u, r = m.x, u = m.y, b(), f.moveTo(m.x, m.y), r = d, u = c, G = m, c = g.nullDataLineDashType, f.setLineDash(M)), f.lineTo(r, u), w && l.lineTo(r, u)) : (f.beginPath(), f.moveTo(r, u), w && (l.beginPath(), l.moveTo(r, u)), G = {
                                        x: r,
                                        y: u
                                    }), ca = d = !1) : (f.lineTo(r, u), w && l.lineTo(r,
                                        u), 0 == h % 250 && b());
                                    m = {
                                        x: r,
                                        y: u
                                    };
                                    h < t.length - 1 && (A !== (t[h].lineColor || v) || c !== (t[h].lineDashType || g.lineDashType)) && (b(), A = t[h].lineColor || v, f.strokeStyle = A, f.setLineDash && (t[h].lineDashType ? (c = t[h].lineDashType, f.setLineDash(J(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(S))));
                                    ...
                                    0 !== t[h].markerSize && (0 < t[h].markerSize || 0 < g.markerSize) && (n = g.getMarkerProperties(h, r,
                                        u, f), D.push(n), Z = Q(Z), w && D.push({
                                        x: r,
                                        y: u,
                                        ctx: l,
                                        type: n.type,
        ...
        n.prototype.renderSplineArea = function(a) {
            function d() {
                ...
                if (0 < c.length) {
                    ...
                    a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? n = r : 0 > a.axisY.viewportMaximum ? n = f.y1 : 0 < a.axisY.viewportMinimum && (n = r);
                    u = {
                        x: c[0].x,
                        y: c[0].y
                    };
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h =
                    ...
                    if (0 < p.length) {
                        ...
                        var C = "solid";
                        if (b.setLineDash) {
                            var A = J(m.nullDataLineDashType,
                                    m.lineThickness),
                                C = m.lineDashType,
                        ...
                        for (t = !1; q < p.length; q++)
                            if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !t)))
                                if ("number" !== typeof p[q].y) 0 < q && !t && (m.connectNullData ? b.setLineDash && (0 < y.length && (m.options.nullDataLineDashType || !p[q - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = A, C = m.nullDataLineDashType) : (d(), y = [])), t = !0;
                                else {
                                    ...
                                    q < p.length - 1 && (G !== (p[q].lineColor || z) || C !== (p[q].lineDashType || m.lineDashType)) && (G = p[q].lineColor || z, y[y.length - 1].newStrokeStyle = G, b.setLineDash && (p[q].lineDashType ? (C = p[q].lineDashType, y[y.length - 1].newLineDashArray = J(C, m.lineThickness)) : (C = m.lineDashType, y[y.length - 1].newLineDashArray = B)));
                                    if (0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < m.markerSize)) {
                                        var S =
                                            m.getMarkerProperties(q, g, t, b);
                                        l.push(S);
                                        M = Q(M);
                                        w && l.push({
                                            x: g,
        ...
        n.prototype.renderStepArea =
            function(a) {
                var d, c;

                function b() {
                    G && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? z = x : 0 > a.axisY.viewportMaximum ? z = s.y1 : 0 < a.axisY.viewportMinimum && (z = x), f.lineTo(n, z), f.lineTo(G.x, z), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(n, z), l.lineTo(G.x, z), l.closePath(), l.fill()), f.beginPath(), f.moveTo(n, u), l.beginPath(), l.moveTo(n, u), G = {
                        x: n,
                        y: u
                    })
                }
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                        ...
                        d = !0;
                        var r = 0,
                            n, u, y, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                                a.axisY.viewportMinimum : 0),
                            z, G = null;
                        c = !1;
                        if (0 < t.length) {
                            ...
                            for (; r < t.length; r++)
                                if (y = t[r].x.getTime ? t[r].x.getTime() : t[r].x, !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                    var Z = u;
                                    "number" !==
                                    typeof t[r].y ? (g.connectNullData || (c || d) || b(), c = !0) : (n = a.axisX.convertValueToPixel(y), u = a.axisY.convertValueToPixel(t[r].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || M === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = n, c = u, n = m.x, u = m.y, b(), f.moveTo(m.x, m.y), n = d, u = c, G = m, M = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(n, Z), f.lineTo(n, u), w && (l.lineTo(n, Z), l.lineTo(n, u))) : (f.beginPath(), f.moveTo(n, u), w && (l.beginPath(), l.moveTo(n, u)), G = {
                                        x: n,
                                        y: u
                                    }), c = d = !1) : (f.lineTo(n, Z), w && l.lineTo(n, Z), f.lineTo(n, u), w && l.lineTo(n, u), 0 == r % 250 && b()), m = {
                                        x: n,
                                        y: u
                                    }, r < t.length - 1 && (A !== (t[r].lineColor || v) || M !== (t[r].lineDashType || g.lineDashType)) && (b(), A = t[r].lineColor || v, f.strokeStyle = A, f.setLineDash && (t[r].lineDashType ? (M = t[r].lineDashType, f.setLineDash(J(M, g.lineThickness))) : (M = g.lineDashType, f.setLineDash(ca)))), y = g.dataPointIds[r], this._eventManager.objectMap[y] = {
                                        id: y,
                                        objectType: "dataPoint",
                                        dataSeriesIndex: q,
                                        dataPointIndex: r,
                                        x1: n,
                                        y1: u
                                    }, 0 !== t[r].markerSize && (0 < t[r].markerSize ||
                                        0 < g.markerSize) && (Z = g.getMarkerProperties(r, n, u, f), h.push(Z), y = Q(y), w && h.push({
                                        x: n,
                                        y: u,
                                        ctx: l,
                                        type: Z.type,
            ...
            function(a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var e = null,
                        ...
                        p = [],
                        q = 0,
                        g, t, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum :
                            0),
                    ...
                    for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                        ...
                        if (0 < m.length) {
                            ...
                            for (var Z = !0, q = 0; q < m.length; q++) {
                                var f = m[q],
                                    ia = null,
                                    ia = 0 <= C.dataPointIndexes[f] ? v[C.dataPointIndexes[f]] : {
                                        x: f,
                                        y: null
                                    };
                                if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !Z)))
                                    if ("number" !== typeof ia.y) C.connectNullData || (Z || y) || d(), Z = !0;
                                    else {
                                        ...
                                        h[f] = r - t;
                                        y || Z ? (!y &&
                                            C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || x === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (y = k.pop(), x = k[k.length - 1], d(), b.moveTo(u.x, u.y), k.push(x), k.push(y), x = C.nullDataLineDashType, b.setLineDash(S)), b.lineTo(g, t), w && n.lineTo(g, t)) : (b.beginPath(), b.moveTo(g, t), w && (n.beginPath(), n.moveTo(g, t))), Z = y = !1) : (b.lineTo(g, t), w && n.lineTo(g, t), 0 == q % 250 && (d(), b.moveTo(g, t), w && n.moveTo(g, t), k.push({
                                            x: g,
                                            y: r - oa
                                        })));
                                        u = {
                                        ...
                                        q < v.length - 1 && (M !== (v[q].lineColor || A) || x !==
                                            (v[q].lineDashType || C.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, t), k.push({
                                            x: g,
                                            y: r - oa
                                        }), M = v[q].lineColor || A, b.strokeStyle = M, b.setLineDash && (v[q].lineDashType ? (x = v[q].lineDashType, b.setLineDash(J(x, C.lineThickness))) : (x = C.lineDashType, b.setLineDash(ca))));
                                        ...
                                        0 <= C.dataPointIndexes[f] && 0 !== ia.markerSize &&
                                            (0 < ia.markerSize || 0 < C.markerSize) && (oa = C.getMarkerProperties(C.dataPointIndexes[f], g, t, b), l.push(oa), f = Q(B), w && l.push({
                                                x: g,
                                                y: t,
                                                ctx: n,
                                                type: oa.type,
                                        ...
                                        (ia.indexLabel || C.indexLabel || ia.indexLabelFormatter || C.indexLabelFormatter) && this._indexLabels.push({
                    ...
                    aa.drawMarkers(l);
                    w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(s.x1, s.y1, s.width, s.height), n.restore());
                    b.restore();
                    return {
                        source: c,
                        dest: this.plotArea.ctx,
        ...
        n.prototype.renderStackedArea100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    q =
                    0,
                    g, t, r, n, u, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (var Z = !0, q = 0; q < m.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !Z)))
                                if ("number" !== typeof ia.y) C.connectNullData || (Z || n) || d(), Z = !0;
                                else {
                                    var oa;
                                    ...
                                    h[f] = y - t;
                                    n || Z ? (!n && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || u === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (n = k.pop(), u = k[k.length - 1], d(), b.moveTo(r.x, r.y), k.push(u), k.push(n), u = C.nullDataLineDashType, b.setLineDash(S)), b.lineTo(g, t), w && x.lineTo(g, t)) : (b.beginPath(), b.moveTo(g, t), w && (x.beginPath(), x.moveTo(g, t))), Z = n = !1) : (b.lineTo(g, t), w && x.lineTo(g, t), 0 == q % 250 && (d(), b.moveTo(g, t), w && x.moveTo(g, t), k.push({
                                        x: g,
                                        y: y - na
                                    })));
                                    r = {
                                    ...
                                    0 <= C.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < C.markerSize) && (na = C.getMarkerProperties(q, g, t, b), s.push(na), f = Q(F), w && s.push({
                                        x: g,
                                        y: t,
                                        ctx: x,
                                        type: na.type,
        ...
        n.prototype.renderBubble = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var s = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
                    for (var m = a.dataSeriesIndexes[k], p = this.data[m], q = p.dataPoints, g = 0, e = 0; e < q.length; e++) f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (g = q[e].z, g > s && (s = g), g < h && (h = g));
                for (var t = 25 * Math.PI, r = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI,
                        t), k = 0; k < a.dataSeriesIndexes.length; k++)
                    if (m = a.dataSeriesIndexes[k], p = this.data[m], q = p.dataPoints, 0 < q.length)
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                                ...
                                var g = q[e].z,
                                    n = 2 * Math.max(Math.sqrt((s === h ? r / 2 : t + (r - t) / (s - h) * (g - h)) / Math.PI) << 0, 1),
                                    g = p.getMarkerProperties(e, c);
                                g.size = n;
                                c.globalAlpha =
                                    p.fillOpacity;
                                aa.drawMarker(f, l, c, g.type, g.size, g.color, g.borderColor, g.borderThickness);
                                c.globalAlpha = 1;
                                ...
                                n = Q(u);
                                w && aa.drawMarker(f, l, this._eventManager.ghostCtx, g.type, g.size, n, n, g.borderThickness);
                    ...
                    if (0 < m.length) {
                        ...
                        for (var p = 0, q = 0, e = 0; e < m.length; e++)
                            if (f = m[e].getTime ? f = m[e].x.getTime() : f = m[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                                ...
                                c.globalAlpha = 1;
                                Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = k.dataPointIds[e], this._eventManager.objectMap[p] = {
                                    id: p,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: h,
                                    dataPointIndex: e,
                                    x1: f,
                                    y1: l
                                }, p = Q(p), w && aa.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness), (m[e].indexLabel || k.indexLabel ||
                                    m[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "scatter",
                                    dataPoint: m[e],
                                    dataSeries: k,
                                    point: {
                    ...
                    if (0 < y.length)
                        for (var x = 5 < t && u.bevelEnabled ? !0 : !1, s = 0; s < y.length; s++)
                            if (y[s].getTime ? g = y[s].x.getTime() : g = y[s].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(y[s].y) && y[s].y.length && "number" === typeof y[s].y[0] && "number" === typeof y[s].y[1] && "number" === typeof y[s].y[2] && "number" === typeof y[s].y[3]) {
                                ...
                                "candlestick" === u.type ? (c.moveTo(h - v, m), c.lineTo(h - v, Math.min(k, q)), c.stroke(), c.moveTo(h -
                                    ...
                                    c.stroke(), w && (e = Q(A), b.strokeStyle = e, b.moveTo(h - v, m), b.lineTo(h - v, p), b.stroke(), b.beginPath(), b.moveTo(h, k), b.lineTo(z, k), b.stroke(), b.beginPath(), b.moveTo(h, q), b.lineTo(G, q), b.stroke()));
        ...
        n.prototype.renderBoxAndWhisker = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    f = this.plotArea,
                    l = 0,
                    s, h, k, m, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                    l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width,
                    t = a.axisX.dataInfo.minDiff;
                isFinite(t) ||
                    (t = 0.3 * Math.abs(a.axisX.range));
                ...
                for (var n = !1, n = !!a.axisY.reversed, fa = 0; fa < a.dataSeriesIndexes.length; fa++) {
                    var u = a.dataSeriesIndexes[fa],
                        y = this.data[u],
                        x = y.dataPoints;
                    if (0 < x.length)
                        for (var z = 5 < t && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)
                            if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] &&
                                "number" === typeof x[l].y[3] && "number" === typeof x[l].y[4] && 5 === x[l].y.length) {
                                ...
                                var v = s - t / 2 << 0,
                                    ...
                                    B = 0 === A % 2 ? 0 : 0.5,
                                    M = x[l].whiskerColor ? x[l].whiskerColor : x[l].color ? y.whiskerColor ? y.whiskerColor :
                                    x[l].color : y.whiskerColor ? y.whiskerColor : e,
                                    S = "number" === typeof x[l].whiskerThickness ? x[l].whiskerThickness : "number" === typeof y.options.whiskerThickness ? y.whiskerThickness : A,
                                    ca = x[l].whiskerDashType ? x[l].whiskerDashType : y.whiskerDashType,
                                    Z = r(x[l].whiskerLength) ? r(y.options.whiskerLength) ? t : y.whiskerLength : x[l].whiskerLength,
                                    Z = "number" === typeof Z ? 0 >= Z ? 0 : Z >= t ? t : Z : "string" === typeof Z ? parseInt(Z) * t / 100 > t ? t : parseInt(Z) * t / 100 : t,
                                    ia = 1 === Math.round(S) % 2 ? 0.5 : 0,
                                    oa = x[l].stemColor ? x[l].stemColor : x[l].color ? y.stemColor ?
                                    y.stemColor : x[l].color : y.stemColor ? y.stemColor : e,
                                    na = "number" === typeof x[l].stemThickness ? x[l].stemThickness : "number" === typeof y.options.stemThickness ? y.stemThickness : A,
                                    ...
                                    I = "number" === typeof x[l].lineThickness ? x[l].lineThickness : "number" === typeof y.options.lineThickness ? y.lineThickness : A,
                                ...
                                c.save();
                                0 < na && (c.beginPath(), c.strokeStyle = oa, c.lineWidth = na, c.setLineDash && c.setLineDash(J(E,
                                    na)), c.moveTo(s - F, k), c.lineTo(s - F, h), c.stroke(), c.moveTo(s - F, p), c.lineTo(s - F, m), c.stroke());
                                c.restore();
                                b.lineWidth = Math.max(A, 4);
                                c.beginPath();
                                da(c, v, Math.min(q, k), C, Math.max(k, q), T, 0, e, n ? z : !1, n ? !1 : z, !1, !1, ua);
                                c.beginPath();
                                da(c, v, Math.min(m, q), C, Math.max(q, m), O, 0, e, n ? !1 : z, n ? z : !1, !1, !1, ua);
                                c.beginPath();
                                c.lineWidth = A;
                                c.strokeStyle = e;
                                ...
                                c.stroke();
                                c.save();
                                0 < I && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(J(P, I)), c.strokeStyle =
                                    K, c.lineWidth = I, c.moveTo(v, q - L), c.lineTo(C, q - L), c.stroke());
                                c.restore();
                                c.save();
                                0 < S && (c.beginPath(), c.setLineDash && c.setLineDash(J(ca, S)), c.strokeStyle = M, c.lineWidth = S, c.moveTo(s - Z / 2 << 0, p - ia), c.lineTo(s + Z / 2 << 0, p - ia), c.stroke(), c.moveTo(s - Z / 2 << 0, h + ia), c.lineTo(s + Z / 2 << 0, h + ia), c.stroke());
                                c.restore();
                                w && (e = Q(R), b.strokeStyle = e, b.lineWidth = na, 0 < na && (b.moveTo(s - B - F, k), b.lineTo(s - B - F, Math.max(h, p)), b.stroke(), b.moveTo(s - B - F, Math.min(h, p)), b.lineTo(s - B - F, m), b.stroke()), da(b, v, Math.max(k, m), C, Math.min(k,
                                    m), e, 0, null, !1, !1, !1, !1), 0 < S && (b.beginPath(), b.lineWidth = S, b.moveTo(s + Z / 2, p - ia), b.lineTo(s - Z / 2, p - ia), b.stroke(), b.moveTo(s + Z / 2, h + ia), b.lineTo(s - Z / 2, h + ia), b.stroke()));
                        ...
                        if (0 < g.length)
                            for (var t = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                                if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !r(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                                    ...
                                    da(c, a.axisX.reversed ?
                                        fa : n, l, a.axisX.reversed ? n : fa, s, b, 0, b, t, t, !1, !1, q.fillOpacity);
                                    b = Q(u);
                                    w && da(this._eventManager.ghostCtx, a.axisX.reversed ? fa : n, l, a.axisX.reversed ? n : fa, s, b, 0, null, !1, !1, !1, !1);
        ...
        n.prototype.renderError = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    l = this.plotArea,
                    s = 0,
                    h, k, m, p, q, g, t, n = a.axisX.dataInfo.minDiff;
                ...
                for (var fa = 0, u = 0; u < this.data.length; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && fa || fa++;
                for (var y =
                    ...
                    u = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) :
                        Math.abs(n) / Math.abs(a.axisX.range)) / (C ? fa : 1)) << 0;
                    ...
                    if (0 < v.length)
                        for (var E = z._colorSet, s = 0; s < v.length; s++) {
                            var e = z.lineColor = z.options.color ? z.options.color : E[0],
                                M = {
                                    color: v[s].whiskerColor ? v[s].whiskerColor : v[s].color ? z.whiskerColor ? z.whiskerColor :
                                        v[s].color : z.whiskerColor ? z.whiskerColor : e,
                            ...
                            M.length = "number" === typeof M.length ? 0 >= M.length ? 0 : M.length >= u ? u : M.length : "string" === typeof M.length ? parseInt(M.length) * u / 100 > u ? u : parseInt(M.length) *
                                u / 100 > u : u;
                            ...
                            if (!(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) &&
                                !r(v[s].y) && v[s].y.length && "number" === typeof v[s].y[0] && "number" === typeof v[s].y[1]) {
                                ...
                                b ? p = ca : g = ca;
                                b ? (q = a.axisX.reversed ? k + (C ? fa : 1) * u / 2 - (C ? A - 1 : 0) * u << 0 : k - (C ? fa : 1) * u / 2 + (C ? A - 1 : 0) * u << 0, g = a.axisX.reversed ? q - u << 0 : q + u << 0) : (m = a.axisX.reversed ? h + (C ? fa : 1) * u / 2 - (C ? A - 1 : 0) * u << 0 : h - (C ? fa : 1) * u / 2 + (C ? A - 1 : 0) * u << 0, p = a.axisX.reversed ? m - u << 0 : m + u << 0);
                                !b && q > g && (ca = q, q = g, g = ca);
                                b &&
                                    m > p && (ca = m, m = p, p = ca);
                                ca = z.dataPointIds[s];
                                ...
                                B(c, Math.min(m, p), Math.min(q, g), Math.max(p, m), Math.max(g, q), e, M, S, b);
                                ...
                                if (v[s].indexLabel || z.indexLabel || v[s].indexLabelFormatter || z.indexLabelFormatter) this._indexLabels.push({
                                    ...
                                    indexKeyword: 1,
                                    point: {
                                        x: b ? v[s].y[1] >= v[s].y[0] ? p : m : m + (p - m) / 2,
                    ...
                    if (0 < t.length) {
                        ...
                        for (f = 0; f < t.length; f++)
                            if (t[f].getTime ? k = t[f].x.getTime() : k = t[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(t[f].y) && t[f].y.length && "number" === typeof t[f].y[0] && "number" === typeof t[f].y[1]) {
                                ...
                                h = a.axisX.reversed ? h + a.plotType.totalDataSeries * m / 2 - (a.previousDataSeriesCount + p) *
                                    m << 0 : h - a.plotType.totalDataSeries * m / 2 + (a.previousDataSeriesCount + p) * m << 0;
                                var v = a.axisX.reversed ? h - m << 0 : h + m << 0;
                                l > s && (b = l, l = s, s = b);
                                b = t[f].color ? t[f].color : g._colorSet[f % g._colorSet.length];
                                da(c, l, a.axisX.reversed ? v : h, s, a.axisX.reversed ? h : v, b, 0, null, n, !1, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = Q(b);
                                w && da(this._eventManager.ghostCtx, l, a.axisX.reversed ? v : h, s, a.axisX.reversed ? h : v, b, 0,
                                    null, !1, !1, !1, !1);
                ...
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < p.length) {
                        ...
                        for (var M = !0; g < p.length; g++)
                            if (u = p[g].x.getTime ?
                                p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !M)))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || M ? (m.connectNullData && !q ? (b.setLineDash && (m.options.nullDataLineDashType || C === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = E, C = m.nullDataLineDashType,
                                        b.setLineDash(B)), b.lineTo(t, r), w && e.lineTo(t, r), h.push({
                                        x: t,
                                        y1: r,
                                        y2: n
                                    ...
                                    g < p.length - 1 && (A !== (p[g].lineColor || v) || C !== (p[g].lineDashType || m.lineDashType)) && (d(), A = p[g].lineColor || v, h[h.length -
                                        1].newStrokeStyle = A, b.strokeStyle = A, b.setLineDash && (p[g].lineDashType ? (C = p[g].lineDashType, h[h.length - 1].newLineDashArray = J(C, m.lineThickness), b.setLineDash(h[h.length - 1].newLineDashArray)) : (C = m.lineDashType, h[h.length - 1].newLineDashArray = E, b.setLineDash(E))));
                    ...
                    if (0 < m.length) {
                        ...
                        for (g = !1; p < m.length; p++)
                            if (q = m[p].x.getTime ? m[p].x.getTime() : m[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))
                                if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" ===
                                    typeof m[p].y[1]) {
                                    ...
                                    p < m.length - 1 && (x !== (m[p].lineColor || y) || z !== (m[p].lineDashType || k.lineDashType)) && (x = m[p].lineColor || y, r[r.length - 1].newStrokeStyle = x, b.setLineDash && (m[p].lineDashType ? (z = m[p].lineDashType,
                                    ...
                                    if (m[p].indexLabel ||
                                        k.indexLabel || m[p].indexLabelFormatter || k.indexLabelFormatter) this._indexLabels.push({
                                    ...
                                    g = !1
                                } else 0 < p && !g && (k.connectNullData ? b.setLineDash && (0 < r.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType)) && (r[r.length -
                                    1].newLineDashArray = C, z = k.nullDataLineDashType) : (d(A, y), r = [], n = [])), g = !0;
                        d(A, y);
                        aa.drawMarkers(f)
                    }
                }
        ...
        n.prototype.renderWaterfall = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx,
                    ...
                    f = this.plotArea,
                    l = 0,
                    s, h, k, m, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < n.length)
                        for (var x = 5 < q && r.bevelEnabled ? !0 : !1, v = !1, A = null, C = null, l = 0; l < n.length; l++)
                            if (n[l].getTime ? m = n[l].x.getTime() : m = n[l].x, "number" !== typeof n[l].y) {
                                if (0 < l && !v && r.connectNullData) var B =
                                    r.options.nullDataLineDashType || !n[l - 1].lineDashType ? r.nullDataLineDashType : n[l - 1].lineDashType;
                                v = !0
                            } else {
                                ...
                                s = a.axisX.reversed ? s + a.plotType.totalDataSeries * q / 2 - (a.previousDataSeriesCount + g) * q << 0 : s - a.plotType.totalDataSeries * q / 2 + (a.previousDataSeriesCount +
                                    g) * q << 0;
                                ...
                                var M = n[l].color ? n[l].color : 0 < n[l].y ? r.risingColor : r.fallingColor;
                                da(c, a.axisX.reversed ? E : s, a.axisY.reversed ? k : h, a.axisX.reversed ? s : E, a.axisY.reversed ? h : k, M, 0, M, x, x, !1, !1, r.fillOpacity);
                                e = Q(e);
                                w && da(this._eventManager.ghostCtx, a.axisX.reversed ? E : s, h, a.axisX.reversed ? s :
                                    E, k, e, 0, null, !1, !1, !1, !1);
                                var S, M = s;
                                S = "undefined" !== typeof n[l].isIntermediateSum && !0 === n[l].isIntermediateSum || "undefined" !== typeof n[l].isCumulativeSum && !0 === n[l].isCumulativeSum ? 0 < n[l].y ? h : k : 0 < n[l].y ? k : h;
                                0 < l && A && (!v || r.connectNullData) && (v && c.setLineDash && c.setLineDash(J(B, u)), c.beginPath(), c.moveTo(A, C - y), c.lineTo(M, S - y), 0 < u && c.stroke(), w && (b.beginPath(), b.moveTo(A, C - y), b.lineTo(M, S - y), 0 < u && b.stroke()));
                                v = !1;
                                A = E;
                                C = 0 < n[l].y ? h : k;
                                M = n[l].lineDashType ? n[l].lineDashType : r.options.lineDashType ? r.options.lineDashType :
                                    "shortDash";
                                c.strokeStyle = n[l].lineColor ? n[l].lineColor : r.options.lineColor ? r.options.lineColor : "#9e9e9e";
                                c.lineWidth = u;
                                c.setLineDash && (M = J(M, u), c.setLineDash(M));
                                (n[l].indexLabel || r.indexLabel || n[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "waterfall",
                                    dataPoint: n[l],
                                    dataSeries: r,
                                    point: {
        ...
        n.prototype.renderPie = function(a) {
            function d() {
                if (k && m) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
                        ...
                        p = f.indexLabelFormatter ? f.indexLabelFormatter(s) :
                            f.indexLabel ? n.replaceKeywordsWithValue(f.indexLabel, f, k, e) : k.indexLabelFormatter ? k.indexLabelFormatter(s) : k.indexLabel ? n.replaceKeywordsWithValue(k.indexLabel, f, k, e) : f.label ? f.label : "";
            ...
            function c(a) {
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (d > c) {
                        ...
                        } else if (0 < Math.abs(g[b].center.x - x.x) || 0 < Math.abs(g[b].center.y - x.y)) g[b].center.x = x.x + e * (1 - a), g[b].center.y = x.y + f * (1 - a),
                            l = !0;
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < m.length) {
                    ...
                    q = e(a);
                    h = k = 0;
                    0 > c ? (h = "right" === p.hemisphere ? s : q, l = c, null !== h && (s = -c, c = p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - (g[h].indexLabelTextBlock.y + g[h].indexLabelTextBlock.height / 2), c - s < t && (k = -s, h = f(h, k, d + 1), +h.toFixed(y) > +k.toFixed(y) && (l = c > t ? -(c - t) : -(s - (h - k)))))) : 0 < c && (h = "right" === p.hemisphere ?
                        q : s, l = c, null !== h && (s = c, c = g[h].indexLabelTextBlock.y - g[h].indexLabelTextBlock.height / 2 - (p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2), c - s < t && (k = s, h = f(h, k, d + 1), +h.toFixed(y) < +k.toFixed(y) && (l = c > t ? c - t : s - (k - h)))));
                        ...
                        for (var s, r, a = 0; a < m.length; a++) {
                            ...
                            if (null !== u) {
                                ...
                                if (0 > z) {
                                    ...
                                    var A = -1 * (z - r),
                                        J = G = 0;
                                    "right" === h.hemisphere ? (G = f(a, r), A = -1 * (z - G), J = f(u, A), +J.toFixed(y) <
                                        +A.toFixed(y) && +G.toFixed(y) <= +r.toFixed(y) && f(a, -(A - J))) : (G = f(u, r), A = -1 * (z - G), J = f(a, A), +J.toFixed(y) < +A.toFixed(y) && +G.toFixed(y) <= +r.toFixed(y) && f(u, -(A - J)))
                                }
                            }
                        }
                    } else
                        for (a = 0; a < m.length; a++) h = g[a], w = "pie" === k.type ? 0.7 * C : 0.8 * C, u = x.x + w * Math.cos(h.midAngle), r = x.y + w * Math.sin(h.midAngle), h.indexLabelTextBlock.x = u, h.indexLabelTextBlock.y = r;
                    for (a = 0; a < m.length; a++)
                            ...
                            if (f = !1, s = g[k], s.indexLabelText) {
                                ...
                                if (null !== l) {
                                    ...
                                    if (q = 0 > z) {
                                        ...
                                        var r = s.indexLabelTextBlock.y - s.indexLabelTextBlock.height /
                                            2,
                                            t = s.indexLabelTextBlock.y + s.indexLabelTextBlock.height / 2,
                                            n = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2,
                                            u = h.indexLabelTextBlock.x + h.indexLabelTextBlock.width,
                                            D = h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2;
                                        q = s.indexLabelTextBlock.x + s.indexLabelTextBlock.width < h.indexLabelTextBlock.x - p || q > u + p || r > D + p || t < n - p ? !1 : !0
                                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k =
                    ...
                    z = 0;
                a = !1;
                for (var A = 0; A < m.length; A++) z += Math.abs(m[A].y), !a && ("undefined" !== typeof m[A].indexLabel && null !== m[A].indexLabel && 0 < m[A].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof m[A].label && null !== m[A].label && 0 < m[A].label.toString().length) && (a = !0);
                if (0 !== z) {
                    ...
                    this.pieDoughnutClickHandler = function(a) {
                        n.isAnimating || !r(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && n._animator.animate(0,
                            500,
                            function(a) {
                                c(a);
                                h();
        ...
        n.prototype.renderFunnel =
            function(a) {
                ...
                function c() {
                    ...
                    if (0 ===
                        g) return -1;
                    for (var l = d[0] = 0, h = 0, m, p, b = b - a, l = !1, k = 0; k < y.length; k++) a = Math.abs(y[k].y) * f / g, l ? m = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = ba * ba * b * b - 4 * Math.abs(ba) * a, 0 > p ? (p = c, l = (b + p) * (e - h) / 2, a -= l, m = e - h, h += e - h, m += 0 == p ? 0 : a / p, h += a / p, l = !0) : (m = (Math.abs(ba) * b - Math.sqrt(p)) / 2, p = b - 2 * m / Math.abs(ba), h += m, h > e && (h -= m, p = c, l = (b + p) * (e - h) / 2, a -= l, m = e - h, h += e - h, m += a / p, h += a / p, l = !0), b = p)), d.push(m);
                    return d
                }

                function b() {
                    if (u && y) {
                        for (var a, b, c, d, e, f, k, l, h, m, p, q, s, t, n, D = [], x = [], v = {
                                percent: null,
                                total: null
                            }, z = null, C = 0; C < y.length; C++) n =
                            R[C], n = "undefined" !== typeof n.x5 ? (n.y2 + n.y4) / 2 : (n.y2 + n.y3) / 2, n = g(n).x2 + 1, D[C] = K - n - W;
                        n = 0.5 * W;
                        for (var C = 0, B = y.length - 1; C < y.length || 0 <= B; C++, B--) {
                            ...
                            "inside" === u.indexLabelPlacement && (D[C] = C !== da ? u.reversed ? R[C].x2 - R[C].x1 : R[C].x3 - R[C].x4 : R[C].x3 - R[C].x6, 20 > D[C] && (D[C] = C !== da ? u.reversed ? R[C].x3 - R[C].x4 : R[C].x2 - R[C].x1 : R[C].x2 - R[C].x1, D[C] /= 2));
                            s = b.indexLabelMaxWidth ? b.indexLabelMaxWidth :
                ...
                function e() {
                    ...
                    e = !1;
                    c = 0;
                    for (var g, k = K - Y - W / 2, k = u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth > k ? k : u.indexLabelMaxWidth : k, l = H.length - 1; 0 <= l; l--) {
                        g = y[H[l].id];
                        c = H[l];
                        d = c.textBlock;
                    ...
                    if (e)
                        for (l = H.length - 1; 0 <= l; l--) a = R[l], H[l].textBlock.maxWidth = f[f.length - (l + 1)], H[l].textBlock.measureText(), H[l].textBlock.x = K - k, c = H[l].textBlock.height < H[l].textBlock.maxHeight ? H[l].textBlock.height :
                            H[l].textBlock.maxHeight, e = H[l].textBlock.width < H[l].textBlock.maxWidth ? H[l].textBlock.width : H[l].textBlock.maxWidth, H[l].height = c, H[l].width = e, c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, H[l].textBlock.y = c - H[l].height / 2, u.reversed ? (H[l].textBlock.y + H[l].height > pa + z && (H[l].textBlock.y = pa + z - H[l].height), H[l].textBlock.y < ua - z && (H[l].textBlock.y = ua - z)) : (H[l].textBlock.y < pa - z && (H[l].textBlock.y = pa - z), H[l].textBlock.y + H[l].height > ua + z && (H[l].textBlock.y = ua + z - H[l].height))
                }
                ...
                function f() {
                    ...
                    if ("inside" !== u.indexLabelPlacement)
                        for (var e = 0; e < R.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = R[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? "undefined" !== typeof a.x5 ? c > U ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < U ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, H[e].textBlock.x = b + W, H[e].textBlock.y = c - H[e].height / 2, u.reversed ? (H[e].textBlock.y + H[e].height > pa + z && (H[e].textBlock.y = pa + z - H[e].height), H[e].textBlock.y < ua - z && (H[e].textBlock.y =
                            ua - z)) : (H[e].textBlock.y < pa - z && (H[e].textBlock.y = pa - z), H[e].textBlock.y + H[e].height > ua + z && (H[e].textBlock.y = ua + z - H[e].height)));
                    else
                ...
                function l() {
                    ...
                    function b() {
                        ...
                        for (var k, h = 1; h < l; h++) {
                            e = h * f;
                            for (var s = H.length - 1; 0 <= s; s--) !H[s].isDirty && (H[s].textBlock.y < e && H[s].textBlock.y + H[s].height > e) && (k = q(s), !(k >= H.length - 1) && H[s].textBlock.y + H[s].height + ea > H[k].textBlock.y && (H[s].textBlock.y = H[s].textBlock.y +
                                H[s].height - e > e - H[s].textBlock.y ? e + 1 : e - H[s].height - 1))
                        }
                    ...
                    for (var d, e, f, g, l, k, m = 1, r = 0; r < 2 * m; r++) {
                        for (var n = H.length - 1; 0 <= n && !(0 <= p(n) && p(n), f = H[n], g = f.textBlock, k = (l = q(n) < R.length ? H[q(n)] : null) ? l.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (l && e + d + ea > +k.y.toFixed(6)) && (d = g.y + d + ea - k.y,
                                e = a(n, -d), e < d && (0 < e && (d -= e), e = a(q(n), d), e != d))); n--);
                        b()
                    }
                }

                function h(a, b) {
                    return (b < R.length ? H[b].textBlock.y : u.reversed ? pa + z : ua + z) - (0 > a ? u.reversed ? ua - z : pa - z : H[a].textBlock.y + H[a].height + ea)
                }
                    ...
                    if (0 === X.length) l = ja;
                        ...
                        for (var s = 0; s < R.length; s++) {
                            if (1 == X.length && 0 == X[0]) {
                                ...
                                s && (d = -1 * h);
                            l.push(ja[s] + d);
                            if (0 <= X.indexOf(s) || s < R.length && 0 <= X.indexOf(s + 1)) d += e
                        }
                    }
                    g = function() {
                ...
                var A = this;
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    for (var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, x = this.plotArea, z = 0.025 * x.width, B = 0.01 * x.width, C = 0, E = x.height - 2 * z, I = Math.min(x.width - 2 * B, 2.8 * x.height), M = !1, S = 0; S < y.length; S++)
                        if (!M && ("undefined" !== typeof y[S].indexLabel && null !== y[S].indexLabel && 0 < y[S].indexLabel.toString().length) && (M = !0), !M && ("undefined" !== typeof y[S].label && null !== y[S].label && 0 < y[S].label.toString().length) && (M = !0), !M && "function" === typeof u.indexLabelFormatter ||
                            "function" === typeof y[S].indexLabelFormatter) M = !0;
                    ...
                    if (0 != u.length && (u.dataPoints && u.visible) && 0 !== y.length) {
                        ...
                        if (-1 !== S) {
                            if (u.reversed)
                                for (I.push($), F = S.length -
                                    1; 0 < F; F--) $ += S[F], I.push($);
                            else
                                for (F = 0; F < S.length; F++) $ += S[F], I.push($);
                            if (u.reversed)
                                for (F = 0; F < S.length; F++) I[F] < U ? (a.push(L), B.push(aa), da = F) : (a.push((I[F] - pa + ba * V) / ba), B.push((I[F] - pa + ga * Y) / ga));
                            else
                                for (F = 0; F < S.length; F++) I[F] < U ? (a.push((I[F] - pa + ba * V) / ba), B.push((I[F] - pa + ga * Y) / ga), da = F) : (a.push(L), B.push(aa));
                            for (F = 0; F < S.length - 1; F++) $ = u.reversed ? y[y.length - 1 - F].color ? y[y.length - 1 - F].color : u._colorSet[(y.length - 1 - F) % u._colorSet.length] : y[F].color ? y[F].color : u._colorSet[F % u._colorSet.length],
                                F === da ? R.push({
                                    x1: a[F],
                                    y1: I[F],
                                    x2: B[F],
                            ...
                            a = a = 0;
                            Da(X);
                            for (F = 0; F < y.length; F++) y[F].exploded && (S = !0, u.reversed ? X.push(y.length - 1 - F) : X.push(F));
                            O.clearRect(x.x1, x.y1, x.width, x.height);
                            O.fillStyle = A.backgroundColor;
                            O.fillRect(x.x1, x.y1, x.width, x.height);
                            if (M &&
                                u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) {
                                l();
                                for (F = 0; F < y.length; F++) H[F].isDirty || (a = H[F].textBlock.x + H[F].width, a = (K - a) / 2, 0 == F && (C = a), C > a && (C = a));
                                for (F = 0; F < R.length; F++) R[F].x1 += C, R[F].x2 += C, R[F].x3 += C, R[F].x4 += C, R[F].x5 && (R[F].x5 += C, R[F].x6 += C), H[F].textBlock.x += C
                            }
                            for (F = 0; F < R.length; F++) C = R[F], ta(O, C, u.fillOpacity), ja.push(C.y1);
                            v(O);
                            M && u.visible && ("inside" === u.indexLabelPlacement || A.animationEnabled || m(O), A.animationEnabled || t());
                            if (!M)
                            ...
                            !A.animationEnabled && S ? n(A, -1, 0) : A.animationEnabled && !A.animatedRender && n(A, -1, 0);
        ...
        n.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                if ("x" === a)
                    ...
                    } else return ha(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", f._cultureInfo);
                else return "y" ===
                    a ? ha(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" === a ? ha(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", f._cultureInfo) : g
            })
        };
        qa(O, $);
                ...
                if (p.dataPoints && p.dataPoints.length)
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                        var q = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !==
                            p.type && "bubble" !== p.type || !p.markerType ? "error" === p.type && p._linkedSeries ? p._linkedSeries.legendMarkerType ? p._linkedSeries.legendMarkerType : W.getDefaultLegendMarker(p._linkedSeries.type) : W.getDefaultLegendMarker(p.type) : p.markerType,
                            ...
                            t = p.legendMarkerColor = p.legendMarkerColor ? p.legendMarkerColor : p.markerColor ? p.markerColor : "error" === p.type ? r(p.whiskerColor) ?
                        ...
                        for (var y = 0; y < p.dataPoints.length; y++) {
                            var x = p.dataPoints[y],
                                q = x.legendMarkerType ? x.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : W.getDefaultLegendMarker(p.type),
                                g = x.legendText ? x.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                                    chart: this.chart,
                                    legend: this.options,
                                    dataSeries: p,
                                    dataPoint: x
                                }) : x.name ? x.name : "DataPoint: " +
                                (y + 1),
            ...
            if (0 < n.length) {
                ...
                for (m = 0; m < n.length; m++) {
                    ...
                    if (!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
                        ...
                        t = q.textBlock.width + (w + h + ("line" === q.chartType || "spline" ===
            ...
            for (var h = 0, n = 0; n < l.length; n++) {
                for (var k = l[n], m = 0, p = 0; p <
                    ...
                    if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, r + this.lineHeight /
                        2), this.ctx.lineTo(g + 0.85 * this.lineHeight, r + this.lineHeight / 2), this.ctx.stroke(), w -= 0.1 * this.lineHeight;
                    ...
                    aa.drawMarker(g + f / 2, r + this.lineHeight / 2, this.ctx, q.markerType, "error" === q.chartType || "line" === q.chartType || "spline" === q.chartType ? q.markerSize / 2 : q.markerSize, q.markerColor, q.markerBorderColor, q.markerBorderThickness);
                    q.textBlock.x = g + c + f;
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "doughnut":
                                ...
                                r < q.radius && r > v && (r = Math.atan2(d - w.y, a - w.x), 0 > r && (r += 2 * Math.PI), r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)), w = Number(((180 * (q.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), v = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === v && 1 < q.endAngle && (v = 360), w >= v && 0 !== g.y && (v += 360, r < w && (r += 360)), r > w && r < v && (b.push({
                                    dataPoint: g,
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: 0
                        ...
                        for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                if (r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), m = (k - (n + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI /
                                        ...
                                        if (r(this.options.labelWrap))
                                            ...
                                            if (b = t.width + d.width >> 0, g = this.labelFontSize, q < f) b - 2 * f > p && (p = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, r(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ?
                                                ...
                                                g : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * f && b < 3.6 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = m, this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (r(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m) : b > 5 * f && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelFontSize = g, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelAngle = this.labelAngle));
                                                ...
                                                q + this._labels[v - 1].textBlock.measureText().width - 2 * f > p)) p = 0 === v ? q + this._labels[v + 1].textBlock.measureText().width - 2 * f : q + this._labels[v - 1].textBlock.measureText().width - 2 * f, this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m;
                                        else if (0 === p)
                                    ...
                                    this.options.labelMaxWidth : m) : (r(this.options.labelMaxWidth), this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : m, this.sessionVariables.labelWrap = this.labelWrap), this.sessionVariables.labelMaxHeight = l)
        ...
        A.setLayout = function(a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks &&
                    ...
                    for (var t = q[g].scaleBreaks._appliedBreaks, w = 0; w < t.length && !(t[w].startValue > q[g].viewportMaximum); w++) t[w].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w), t[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
            for (var v = w = 0, u = 0, y = 0, x = 0, z = 0, A = 0, C, B, E = h = 0, I, J, K, t = I = J = K = !1, g = 0; g < q.length; g++) q[g] && q[g].title && (q[g]._titleTextBlock = new ka(q[g].ctx, {
                text: q[g].title,
                horizontalAlign: "center",
            ...
            if ("normal" === e) {
                for (var y = [], x = [], z = [], A = [], N = [], Q = [], O = [], P = []; 4 >
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) L = m.isNavigator ? 0 : 10, c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p, h = Math.round(f.y1 + Y + X < Math.max(L, p) ? Math.max(L, p) : f.y1 + Y + X), n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height /
                            2 : p, k = Math.round(f.y2 - U - e - L), c[g].lineCoordinates = {
                                x1: l - W,
                                y1: h,
                                x2: n - W,
                                y2: k,
                                ...
                                c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), W += z[g] + c[g].margin);
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), n = Math.round(l), L = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + Y + X < Math.max(L, p) ? Math.max(L, p) : f.y1 + Y + X), L = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (U + e + L)), b[g].lineCoordinates = {
                            ...
                            b[g].lineCoordinates.height), V += A[g] + b[g].margin);
                    if (a && 0 < a.length)
                    ...
                    if (0 < w) {
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) t = N[w - 1][g] === N[w][g] ? !0 : !1;
                        else t = !0;
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) I = Q[w - 1][g] === Q[w][g] ? !0 : !1;
                        else I = !0;
                        if (c && 0 < c.length)
                ...
                for (Q = []; 4 > w;) {
                    ...
                    if (m.panEnabled)
                        for (g = 0; g < c.length; g++) p[g] = r(m.sessionVariables.axisY.height) ?
                    ...
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--) b[g] && (h = Math.round(f.y1), k = Math.round(f.y1 + (C[g] + b[g].margin + F)), b[g].lineCoordinates.y1 =
                            k, b[g].lineCoordinates.y2 = k, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = k - C[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = {
                                x1: l,
                                y1: h + (b[g].margin + F),
                                x2: n,
                                y2: k,
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            ...
                            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - W > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2 - W) : f.y2 > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2;
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n, l =
                                    0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - V : l);
                            if (b && 0 < b.length)
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - W > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2 - W) : f.y2 > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2;
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n, l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - U : l);
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++) b[L] &&
                                    b[L].labelAutoFit && (n = b[L].lineCoordinates.x2, l = n - U);
                            d[g].lineCoordinates = {
                                x1: n + P,
                                y1: h,
                                x2: n + P,
                    ...
                    if (0 < w) {
                        ...
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) I = Q[w - 1][g] === Q[w][g] ? !0 :
                                !1;
                        else I = !0;
                        if (c && 0 < c.length)
        ...
        ba.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    for (var B = 0; B < this.parent.dataSeries.length; B++)(v = this.parent.dataSeries[B].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B], null !== v.dataPoint.y && v.dataSeries.visible &&
                        m.push(v));
                    v = null;
                    ...
                    if ("rangeBar" === m[0].dataSeries.type || "error" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[B].dataPoint.y[0])), u = 0, t = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length)
                                for (var y = 0; y < m[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y[y])), u < v && (v = u, B = t);
                            else u =
                                Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y)), u < v && (v = u, B = t);
                    else if ("stackedBar" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), x = u = 0, t = B = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length)
                                for (y = 0; y < m[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y[y])), u < v && (v = u, B = t);
                            else x += m[t].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < v && (v = u, B = t);
                    else if ("stackedBar100" === m[0].dataSeries.type)
                        for (var v =
                                Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), z = x = u = 0, t = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length)
                                for (y = 0; y < m[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y[y])), u < v && (v = u, B = t);
                            else x += m[t].dataPoint.y, z = m[t].dataPoint.x.getTime ? m[t].dataPoint.x.getTime() : m[t].dataPoint.x, z = 100 * (x / m[t].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, B = t);
                    else
                        for (v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)),
                            t = B = u = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length)
                                for (y = 0; y < m[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y[y])), u < v && (v = u, B = t);
                            else u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y)), u < v && (v = u, B = t);
                    y = m[B];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type) {
                            ...
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            x = u = 0;
                            for (t = B; 0 <= t; t--) x += m[t].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < v && (v = u, b = t);
                            ...
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            z = x = u = 0;
                            for (t = B; 0 <= t; t--) x += m[t].dataPoint.y, z = m[t].dataPoint.x.getTime ? m[t].dataPoint.x.getTime() : m[t].dataPoint.x, z = 100 * (x / m[t].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, b = t);
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                crosshair: this.options,
                                value: z
                            }) : r(this.options.label) ? ha(r(c) ? z : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                        ...
                        if (this.parent.labels)
                            for (m = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t +=
                                m)
                            ...
                            if ("axisX" === this.parent.type)
                                for (t = this.parent.convertPixelToValue({
                                        y: d
                                    }), v = null, B = 0; B < this.parent.dataSeries.length; B++)(v = this.parent.dataSeries[B].getDataPointAtX(t, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({
                                    chart: this.chart,
                                    axis: this.parent.options,
                                    crosshair: this.options,
                                    value: y.dataPoint.x
                    ...
                    for (B = 0; B < this.parent.dataSeries.length; B++)(v =
                        this.parent.dataSeries[B].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    if (0 === m.length) return;
                    m.sort(function(a, b) {
                        return a.distance - b.distance
                    });
                    ...
                    if (this.parent.labels)
                        for (m = Math.ceil(this.parent.interval),
                            t = 0; t < this.parent.viewportMaximum; t += m)
                            if (this.parent.labels[t]) z = !0;
                            else {
                                z = !1;
                                break
                    ...
                    for (B = 0; B < this.parent.dataSeries.length; B++)(v = this.parent.dataSeries[B].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    if (0 === m.length) return;
                    m.sort(function(a, b) {
                        return a.distance - b.distance
                    });
                    ...
                    if ("rangeColumn" === m[0].dataSeries.type || "rangeArea" === m[0].dataSeries.type || "error" === m[0].dataSeries.type || "rangeSplineArea" === m[0].dataSeries.type || "candlestick" === m[0].dataSeries.type || "ohlc" === m[0].dataSeries.type ||
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])), t = u = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length)
                                for (y = 0; y < m[t].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y[y])), u < v && (v = u, B = t);
                            else u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y)), u < v && (v = u, B = t);
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)),
                            t = x = u = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length)
                                for (y = 0; y < m[t].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y[y])), u < v && (v = u, B = t);
                            else x += m[t].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < v && (v = u, B = t);
                    else if ("stackedColumn100" === m[0].dataSeries.type || "stackedArea100" === m[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), t = z = x = u = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length)
                                for (y =
                                    0; y < m[t].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y[y])), u < v && (v = u, B = t);
                            else x += m[t].dataPoint.y, z = m[t].dataPoint.x.getTime ? m[t].dataPoint.x.getTime() : m[t].dataPoint.x, z = 100 * (x / m[t].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(d - this.parent.convertValueToPixel(z)), u < v && (v = u, B = t);
                    else
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), t = u = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length)
                                for (y = 0; y < m[t].dataPoint.y.length; y++) u =
                                    Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y[y])), u < v && (v = u, B = t);
                            else u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y)), u < v && (v = u, B = t);
                    y = m[B];
                    b = 0;
                    if ("rangeColumn" === this.parent.dataSeries[B].type || "rangeArea" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type || "rangeSplineArea" === this.parent.dataSeries[B].type || "candlestick" === this.parent.dataSeries[B].type || "ohlc" === this.parent.dataSeries[B].type || "boxAndWhisker" === this.parent.dataSeries[B].type) {
                        ...
                        x = u = 0;
                        for (t = B; 0 <= t; t--) x += m[t].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < v && (v = u, b = t);
                        ...
                        v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y));
                        x = u = 0;
                        for (t = B; 0 <= t; t--) x += m[t].dataPoint.y, z = m[t].dataPoint.x.getTime ? m[t].dataPoint.x.getTime() : m[t].dataPoint.x, z = 100 * (x / m[t].dataSeries.plotUnit.dataPointYSums[z]),
                            u = Math.abs(d - this.parent.convertValueToPixel(z)), u < v && (v = u, b = t);
                    ...
                    }) : r(this.options.label) ? ha(r(c) ? y.dataSeries.dataPointEOs[y.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = y.dataSeries.dataPointEOs[y.index].cumulativeSum) : (w = 1 === q.lineWidth % 2 ? (r(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) <<
                    ...
                    if (this.chart.axisX)
                        for (var v = 0; v < this.chart.axisX.length; v++) {
                            for (var h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[v].convertPixelToValue({
                                    ...
                                    x: a
                                }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)(k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && n.push(k));
                            k = null
                        }
        ...
        X.prototype.getNewObjectTrackingId =
            function() {
