...
?>		
			...
			<td align="left">
				<input type="text" id="item_code2" name="item_code2" style="font-size: 11px; width: 150px" class="form-control" readonly value="<?php echo $item_code2 ?>" >
			</td>
			...
			<td>
				<select id="uom_code" name="uom_code" class="form-control" style="font-size: 11px">
					<option value=""></option>
					<?php 
						select_uom($uom_code) 
					?>
			...
			<td align="center">
				<input type="text" id="qty" name="qty" style="text-align: right; font-size: 11px; width: 100px" class="form-control" onKeyPress="return focusNext('submit_det',event)" onkeyup="formatangka('qty'), detailvalue2('persen')" autofocus="" value="1" >
			</td>
