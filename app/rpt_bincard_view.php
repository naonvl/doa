	...
	?>
		...
		<?php
			...
			while($row_bincard=$sql2->fetch(PDO::FETCH_OBJ)) {
                ...
                if($transaction == "work_order") { $transaction = "SPK Bengkel"; }
			...
			?>
				...
				<tr>
					...
					<td align="right" <?php echo $style ?> ><?php echo number_format($debit_qty,"0",",",".") ?>&nbsp;</td>
					<td align="right" <?php echo $style ?> ><?php echo number_format($credit_qty,"0",",",".") ?>&nbsp;</td>
					
					<?php 
						if($transaction == "Stock Opname") {
					?>
							<td align="right" <?php echo $style ?> ><?php echo number_format($total_qty,"0",",",".") ?>
								<br>
								<?php echo number_format($qty_tmp,"0",",",".") ?>&nbsp;
							</td>
					<?php } else { ?>
							<td align="right" <?php echo $style ?> ><?php echo number_format($total_qty,"0",",",".") ?>&nbsp;</td>
					<?php } ?>
				</tr>
