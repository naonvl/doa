...
table {
  ...
  $output .= "<table border='0' width='100%' style='text-align: center; font-size: 14px; margin-left: -240px; margin-top: 180px; transform: rotate(90deg);'>
  <tr >
    <td width='20' align='left' valign='top'>"."<img src='phpqrcode/qrcode/".$ref."' width='70' height='70' />"."</td>
...
//$customPaper = array(0,0,100,410); //430, 115
$customPaper = array(0,0,100,510); //430, 115
