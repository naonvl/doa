            ...
            <tbody>
                <?php for($no=0; $no<5; $no++) { ?>
                    <tr id="item_ajax_<?= $no ?>">
                        ...
                        <td align="left">
                            <div style="width: 300px;max-width: 100%;">
                                <!-- <select class="destroy-selector" id="item_code_<?= $no ?>" name="item_code_<?= $no ?>" onchange="loadHTMLPost4('app/pos_detail_ajax2.php','item_ajax_<?= $no ?>','getdata3','item_code_<?= $no ?>','location_id','no_<?= $no ?>')" >
                                    <option value=""></option>
                                    <php select_item("") ?>
                                </select> -->
